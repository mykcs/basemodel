...
const enGuidePage = read('docs/archive/site-en/src/pages/en/guide.astro');

pass('AV-ROUTES', ['src/pages/index.astro', 'src/pages/workspace/index.astro', 'src/pages/models/index.astro', 'src/pages/papers/index.astro', 'src/pages/landscape/index.astro', 'src/pages/guide.astro', 'src/pages/methodology.astro', 'src/pages/data-status.astro'].every(exists) && !exists('src/pages/en') && exists('docs/archive/site-en/src/pages/en/index.astro'), 'current Chinese research routes are active and the English page tree is archived outside src/pages');
...
pass('AV-GUIDE-HARDWARE-TRUTH', zhGuidePage.includes('启发式规划估算') && zhGuidePage.includes('不是硬件实测') && enGuidePage.includes('heuristic planning estimate') && enGuidePage.includes('not a measured hardware result'), 'current Chinese guide and archived English guide both preserve the hardware-truth boundary');
