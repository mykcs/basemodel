...
pass('V2-DATA-005', ['qwen2-5-0-5b-instruct', 'qwen2-5-1-5b', 'qwen2-5-1-5b-instruct', 'qwen2-5-3b', 'qwen2-5-3b-instruct', 'qwen2-5-7b-instruct', 'qwen2-5-14b-instruct', 'qwen2-5-32b-instruct', 'qwen2-5-72b-instruct'].every((id) => existsSync(join(root, `src/content/models/${id}.json`))), 'Qwen2.5 canonical size ladder includes 0.5B, 1.5B, 3B, 7B, 14B, 32B, and 72B records');
