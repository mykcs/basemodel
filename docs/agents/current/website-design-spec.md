...
3. 先把案例簇总结成一句可复用规则，并同时写清“这条规则不意味着什么”。例如 CASE-061–068 的共同规则不是“删除英文、禁用分叉词或把页面做空”，而是“零上下文首层先展示真实对象、双方和一个最重要事实；首屏只承担一个主要理解任务，内部代号、方法学术语、重复 orientation 和非必要叙事包装后置或删除”。
