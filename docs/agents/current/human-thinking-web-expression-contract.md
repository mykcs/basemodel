...
- When a small label mixes useful metadata with generic narration, keep only the useful metadata. A sequence number, timestamp, version, sealed/historical state, or evidence identity may remain; phrases such as “what we know,” “results,” “metrics,” or “stopping rule” still need independent information value before they earn a separate visual row.
