...
Current ordinary architecture is Vercel Preview + Vercel Production. Historical Cloudflare/Vercel migration states belong under `docs/agents/history/` and must not be restored from an old teaching document.
