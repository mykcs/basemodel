...
- [Deployment policy](https://github.com/mykcs/basemodel/blob/main/docs/agents/current/deployment-policy.md) — self-hosted CI, exact-head opt-in Preview, protected merge, and separate Production verification.
