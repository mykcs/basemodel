...
- [`history/2026-09-10-briefing-fast-preview-pr-workline-and-hpl-closeout-retrospective.md`](history/2026-09-10-briefing-fast-preview-pr-workline-and-hpl-closeout-retrospective.md) — briefing development closeout for same-surface PR proliferation, fast review Preview artifact identity, stale generated-output reuse, and HPL retrieval-capacity regression; current rules live in deployment, multi-PR integration, scenario-trigger, and HPL owners.
