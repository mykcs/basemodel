...
- [`history/2026-09-14-sd-lora-parallel-lineage-and-study-grouping-conversation-closeout.md`](history/2026-09-14-sd-lora-parallel-lineage-and-study-grouping-conversation-closeout.md) — parallel SD-LoRA/VR closeout: separate scientific line identity from umbrella labels, preserve a line before concurrent reconciliation, treat `SD-LoRA v2` as a navigation-only parent when requested without merging child treatments, converge on one integration authority, and record the repeated Fish/Bash use-site failure without duplicating shell policy.
