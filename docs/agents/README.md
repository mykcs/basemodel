...
- [`history/2026-09-07-training-design-human-feedback-sitewide-followthrough-retrospective.md`](history/2026-09-07-training-design-human-feedback-sitewide-followthrough-retrospective.md) — Training Design direct-human-feedback → sitewide shared-owner propagation → stale test/proxy repair → moving-main/CI/Production closeout; also records the concurrent CASE-ID collision and why numbered shared registries need integration-time uniqueness guards.
