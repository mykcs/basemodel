...
- [`history/2026-09-14-parallel-sd-lora-lineage-publication-closeout.md`](history/2026-09-14-parallel-sd-lora-lineage-publication-closeout.md) — parallel-Agent lineage/publication closeout: resolve scientific identity before implementation, search semantic-intent overlap before first write, converge duplicate routers into one integration path, and keep website provenance bound to that same source.
