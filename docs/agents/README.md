...
- [`history/2026-09-08-open-pr-backlog-consolidation-and-exact-head-closeout-retrospective.md`](history/2026-09-08-open-pr-backlog-consolidation-and-exact-head-closeout-retrospective.md) — repository-wide PR backlog consolidation: backlog cleanup as authority migration, unique-delta extraction before closure, one surviving release authority, narrow shared-registry transplantation, concurrent-head non-fast-forward recovery, Fish/Bash recurrence, exact-head CI invalidation, and A/B/C retention boundaries.
