...
- [`history/2026-09-14-pr705-gated-delta-metadata-reconciliation-conversation-closeout.md`](history/2026-09-14-pr705-gated-delta-metadata-reconciliation-conversation-closeout.md) — PR #705 closeout: keep route body and title/description/OG/Twitter metadata on the same scientific state and claim boundary, refresh live `main` before release mutations, and classify protected-Preview SSO as an access boundary rather than an application failure.
- [`history/2026-09-14-sd-lora-parallel-lineage-and-study-grouping-conversation-closeout.md`](history/2026-09-14-sd-lora-parallel-lineage-and-study-grouping-conversation-closeout.md) — parallel SD-LoRA/VR closeout: separate scientific line identity from umbrella labels, preserve a line before concurrent reconciliation, use a neutral navigation umbrella when one child owns the formal treatment/version name, converge on one integration authority, and record the repeated Fish/Bash use-site failure without duplicating shell policy.
- [`history/2026-09-15-sd-lora-context-first-release-closeout.md`](history/2026-09-15-sd-lora-context-first-release-closeout.md) — context-first Vanilla SD-LoRA release closeout: bind `firstViewportSelector` to the smallest real message owner, distinguish selector-scope failure from genuine first-screen overload, and record repeated Fish/Bash plus pre-final-gate merge attempts as activation failures of already-correct current policy.
- [`history/2026-09-14-parallel-pr-convergence-and-merge-order-closeout.md`](history/2026-09-14-parallel-pr-convergence-and-merge-order-closeout.md) — follow-up parallel-PR closeout: cold-read live authority before integrating sibling governance PRs, preserve distinct scientific/publication owners, order independent green merges to minimize exact-head invalidation, and record the repeated accidental provider-write/action mismatch without promoting transient PR/provider state.
- [`history/2026-09-13-sd-lora-v2-publication-study-index-conversation-closeout.md`](history/2026-09-13-sd-lora-v2-publication-study-index-conversation-closeout.md) — SD-LoRA v2 publication closeout: preserve owner-approved conversation prose when publishing, require nearest-parent discoverability and stable canonical route naming, verify phone visibility rather than DOM presence, keep Reader Contract budgets semantic, and avoid `.first()` false failures when responsive markup duplicates a target.
- [`history/2026-09-13-base-model-flow-to-models-conversation-closeout.md`](history/2026-09-13-base-model-flow-to-models-conversation-closeout.md) — Base Model Flow → Models migration closeout: HPL contract must follow the surface actually varied, dirty-tree browser evidence is not exact-head evidence, manual browser checks bind to the server's emitted URL, the repeated Fish/Bash first-probe gap, and checklist-derived progress reporting.
- [`history/2026-09-13-remove-model-navigation-conversation-closeout.md`](history/2026-09-13-remove-model-navigation-conversation-closeout.md) — follow-up navigation closeout: removing a direct Models destination is a shared-shell navigation demotion rather than capability deletion; preserve Compare/search/contextual model paths, and run Phase A cold read from the real default state rather than an artificially expanded menu.
...
- [`history/2026-09-18-basemodel-content-first-apple-guided-redesign-closeout.md`](history/2026-09-18-basemodel-content-first-apple-guided-redesign-closeout.md) — completed whole-site content-first redesign: Apple principles translated into reader purpose/hierarchy rather than surface imitation, semantic shape replacing card/spacer shortcuts, concurrent scientific-owner preservation, repository-owned browser acceptance, and exact-head Vercel → Production closeout.
- [`history/2026-09-21-sitewide-hpl-math-and-release-conversation-closeout.md`](history/2026-09-21-sitewide-hpl-math-and-release-conversation-closeout.md) — site-wide HPL/math closeout: do not double-ingest already-canonical HPL corrections; treat a named defect as a same-family search seed; expire temporary concurrent-owner audit exemptions; recover a missing post-merge Production object only through an exact-main Git-source Production build; and record repeated multiline quoting as an activation failure of the existing shell rule.
- [`history/2026-09-21-vercel-github-author-identity-mismatch-case.md`](history/2026-09-21-vercel-github-author-identity-mismatch-case.md) — Vercel `GitHub user not found` case: repository-local Git identity overrode a valid global identity; diagnose with config origin + effective author + GitHub commit mapping, fix the commit-producing scope, do not rewrite history, and fail the final gate before Vercel when the candidate author does not map to GitHub.
- [`history/2026-09-21-vercel-author-identity-conversation-closeout.md`](history/2026-09-21-vercel-author-identity-conversation-closeout.md) — conversation closeout for the author-identity repair: records the two repeated activation failures (isolated-worktree dependency normalization and pre-merge moving-main refresh), why no duplicate current rule was added, and why stale/unrelated PRs were kept outside the repair merge.
- [`history/2026-09-20-content-first-hpl-closeout-conversation-lessons.md`](history/2026-09-20-content-first-hpl-closeout-conversation-lessons.md) — follow-up conversation closeout after HPL #751: do not double-ingest HPL feedback, treat repeated quoting failures as activation failures, normalize isolated-worktree dependencies before classifying candidate errors, converge concurrent closeout implementations on one survivor, and keep provider observability gaps separate from release evidence.
