...
- [history/2026-09-03-pr420-deterministic-verification-and-exact-head-retrospective.md](history/2026-09-03-pr420-deterministic-verification-and-exact-head-retrospective.md) — PR #420 merge-candidate identity, CSS fail-closed repair, shallow-checkout/base-resolution drift, stale copy assertions, moving-head cancellation, and exact-head CI/Preview evidence.
