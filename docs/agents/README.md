...
- [`history/2026-09-14-sd-lora-canonical-route-and-stale-pr-reconciliation-closeout.md`](history/2026-09-14-sd-lora-canonical-route-and-stale-pr-reconciliation-closeout.md) — Vanilla SD-LoRA route-migration closeout: stale whole-file replay recurrence, canonical-vs-compatibility ownership, direct internal links plus active-state resolution, Production cold-read escapes, moving-main exact-head invalidation, and the repeated Fish/Bash activation miss.
