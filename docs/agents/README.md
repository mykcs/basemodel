...
- [`history/2026-09-15-effective-state-gdr-derivation-and-publication-handoff-closeout.md`](history/2026-09-15-effective-state-gdr-derivation-and-publication-handoff-closeout.md) — Effective-State GDR / LoRA closeout: treatment onset vs non-empty recurrence, effective-state vs factor-coordinate semantics, teacher→runtime realized-state mapping, Pending result scaffolds, long-context checklist handoff, and repeated Fish/provider use-site misses without duplicating current policy.
