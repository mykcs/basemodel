...
6. [`2026-08-09-final-hardening-addendum.md`](./2026-08-09-final-hardening-addendum.md) — final findings: out-of-order Cloudflare PR status comments, Astro 7 whitespace compatibility, public Preview access, recommended `main` ruleset, and automatic Cloudflare skipping for GitHub Actions Dependabot PRs.
