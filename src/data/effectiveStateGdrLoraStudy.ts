...
export const EFFECTIVE_STATE_GDR_LORA_STUDY = {
  ...
  evidence: {
    ...
    betaControllerPreregistration: `${repo}/blob/c5e012814bb9509deb0e2cbc8d57a63e2b56889f/docs/evidence/bounded-recurrence-gdr-20260915/gauge-invariant-beta-policy-v2-prereg-202609151315.json`,
    betaControllerTrainingSource: `${repo}/blob/c5e012814bb9509deb0e2cbc8d57a63e2b56889f/scripts/analysis/gated_delta_gauge_invariant_beta_policy_v2_202609151320.py`,
    betaRuntimeSource: `${repo}/blob/c5e012814bb9509deb0e2cbc8d57a63e2b56889f/scripts/analysis/gated_delta_lora_effective_state_runtime_v1_202609151345.py`,
    carrierReflectorSource: `${repo}/blob/d045568941a987913ab4c4a2b6ee67b5bebb678d/scripts/openevo_webshop/ceiling1_stage2_reflector.py`,
    carrierEvidenceGateSource: `${repo}/blob/d045568941a987913ab4c4a2b6ee67b5bebb678d/scripts/openevo_webshop/ceiling1_stage2_vnext_evidence.py`,
    webshopEvaluatorSource: `${repo}/blob/d045568941a987913ab4c4a2b6ee67b5bebb678d/scripts/openevo_webshop/webshop_task_manifest.py`,
    ...
    q17CarrierAudit: `${repo}/blob/240c479bead0450def3feaaa2a169d9a2bc3934c/docs/troubleshooting/experiment-ops/CASE-GDR-160-LAUNCH-CARRIER-HEALTH-ACCELERATION-CONVERGENCE-202609141740.md`,
  ...
  carrierAnalysis: {
    terminalUpdateDefinition: 'UPDATE means the accepted terminal carrier/state changed and entered the next round; NOOP means the prior state was retained.',
    ordinary: {
      source: 'historical Q17 DirectApply carrier ledger recovered from all 160 sealed ROUND_COMPLETE receipts',
      parameterState: { updates: 159, noops: 1, terminalKind: 'parametric_sd_lora' },
      textMemory: { updates: 2, noops: 158, updateRounds: [7, 95] as const },
      skillBundle: { updates: 1, noops: 159, updateRounds: [0] as const },
      agentSystem: { updates: 3, noops: 157, updateRounds: [41, 115, 148] as const },
      runtimeReadback: {
        recordedEnvironmentSteps: 184478,
        textMemory: { requested: 142208, selected: 142208, distinctSelectedPayloads: 3 },
        skillBundle: { requested: 42270, selected: 42270, distinctSelectedPayloads: 1 },
        agentSystem: { requested: 184478, selected: 175820, distinctSelectedPayloads: 3 },
      },
    },
    bounded: {
      source: 'sealed 160-round Stage2 resource analysis',
      parameterState: { updates: 158, noops: 2, terminalKind: 'bounded_transition' },
      textMemory: { updates: 3, noops: 157 },
      skillBundle: { updates: 0, noops: 160 },
      agentSystem: { updates: 0, noops: 160 },
      producerModelCalls: { textMemory: 72, skillBundle: 320, agentSystem: 320 },
      effectiveHealthReceiptRoundCoverage: 159,
    },
    betaGating: {
      source: 'sealed 160-round Stage2 resource analysis',
      parameterState: { updates: 154, noops: 6, terminalKind: 'bounded_transition' },
      textMemory: { updates: 2, noops: 158 },
      skillBundle: { updates: 0, noops: 160 },
      agentSystem: { updates: 0, noops: 160 },
      producerModelCalls: { textMemory: 22, skillBundle: 320, agentSystem: 320 },
      effectiveHealthReceiptRoundCoverage: 160,
    },
    matchedCarrierContract: 'same Completion-First Carrier Contract v2 on both formal Bounded arms',
    interpretation: 'Across these 160-round runs, the parameter channel was the high-frequency adaptive path; Text Memory, Skill Bundle and Agent System changed much more sparsely.',
    boundary: 'Terminal UPDATE count is not runtime-use, effect, quality or causal-attribution evidence. A reasoned NOOP can be healthy; do not impose update quotas or explain score gaps from update counts alone.',
  },
  parameterAnalysis: {
    off: {
  ...
  posthocAnalysis: {
    ...
    gdr: {
      ...
      controllerTraining: {
        trainedOffline: true,
        frozenDuringFormalRun: true,
        trainRounds: [0, 24, 46, 91] as const,
        validationRound: 114,
        heldoutRound: 136,
        target: 'log10(canonical effective-write beta + 1e-12)',
        architecture: [22, 64, 64, 1] as const,
        activation: 'GELU',
        optimizer: 'AdamW',
        learningRate: 0.001,
        weightDecay: 0.0001,
        ...
        bestEpoch: 48,
        qualificationStatus: 'PASS_GAUGE_INVARIANT_BETA_POLICY_V2',
        heldoutSpearman: 0.9783382381899217,
        heldoutMedianAbsLog10Error: 0.07353067398071289,
        predictedBetaMin: 5.580113736532166e-13,
        predictedBetaMax: 0.004016951657831669,
      },
      formalObserved: {
        betaMin: 1.9415535428662754e-20,
        betaMax: 0.004396725833379047,
        optimizerEvents: 16537,
        appliedWrites: 1053394,
        zeroDirectionNoops: 4974,
        scope: 'final transformer layer q_proj/k_proj/v_proj/o_proj only',
      },
    },
  },
  formalResult: {
