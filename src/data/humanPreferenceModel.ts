...
export const HUMAN_PREFERENCE_MODEL: HumanPreferenceDimension[] = [
  ...
  },
  {
    ...
    title: '机制文案按主体、动作、结果说人话',
    statement: '当科研机制本身是一条可观察动作链时，先写谁训练了什么、谁又做了什么判断、下一状态因此怎样；避免把整个过程压成“X 与 Y 之间存在落差”之类无主体的抽象关系句。',
    scopes: ['research-copy', 'briefing'],
    confidence: 'repeated-explicit',
    priority: 5,
    retrievalTags: ['说人话', '机制', '语序', 'GDR', 'SD-LoRA', '候选', '下一轮', '参数更新'],
    supportingCaseIds: ['CASE-087'],
    antiOvergeneralization: [
      '不是禁止抽象关系词；当“关系”本身就是科研对象时可以精确命名。',
      '不是删除 GDR / SD-LoRA 等专业词；保留真实技术对象，同时把它们的动作和结果说清。',
      '不要把自然语言改成过度口语或牺牲技术因果；主体、动作和状态仍需准确。',
    ],
  },
  {
