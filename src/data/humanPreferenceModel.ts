...
export const HUMAN_PREFERENCE_MODEL: HumanPreferenceDimension[] = [
  ...
  },
  {
    ...
    priority: 4,
    retrievalTags: ['科研汇报', 'briefing', '研究问题', '状态流水账', 'Ceiling', 'Mechanism', 'Control', 'TaskVector', '公式', '工程严谨', 'SHA', '手机', '桌面', '16:9', '参数标题'],
...
export const HUMAN_FEEDBACK_GOLD_PAIRS: HumanFeedbackGoldPair[] = [
  ...
  },
  {
    ...
    caseId: 'CASE-082',
    preferenceIds: ['PREF-DIRECT-FACTS', 'PREF-RESEARCH-JUDGMENT'],
    scopes: ['briefing', 'research-copy'],
    rejected: '2048 → 4096：容量实验',
    accepted: '我们把记忆容量翻倍了（正文保留并强调 2048 → 4096）',
    reason: '实现参数很重要，但标题先说自然语言结论；精确参数留在正文。数字本身若是科研结果仍可前置。',
    failureMechanisms: ['numeric-shock-heading', 'implementation-parameter-as-headline'],
    ownerStatus: 'accepted',
  },
  {
    ...
    failureMechanisms: ['engineering-as-science-highlight', 'mainline-rigor-tax'],
    ownerStatus: 'accepted',
  },
  {
