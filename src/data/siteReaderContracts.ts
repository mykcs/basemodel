...
export const SITE_READER_CONTRACTS = [
  ...
  c('capability-gated-delta', '/research/seed-openevo/study/capability-exploration/gated-delta-sd-lora/', '/research/seed-openevo/study/capability-exploration/gated-delta-sd-lora/', 'narrative', '理解当前 Gated-Delta SD-LoRA 怎样在每次学习时直接更新 LoRA 参数，以及封存的四轮 Vanilla-vs-GDR qualification 支持什么', '先看到 4/4 rounds 已封存：在冻结 D1 schedule 上，GDR 的 pooled reward 与 exact success 都高于 Vanilla', 'Task Vector、WebShop 分数、candidate probe 和 final panel 都不能控制在线参数写入；D1 qualification 不能升级成普遍优越性、跨设置泛化或 final-panel 提升', '沿参数更新机制理解 State 与 beta，再核对四轮 pooled / per-round / cluster-bootstrap 证据和 claim boundary', '.gds-hero__lede', { maxInteractive: 2, maxHeadings: 1, maxTextChars: 760 }),
