...
export const SITE_READER_CONTRACTS = [
  ...
  c('study-briefing', '/research/seed-openevo/study/briefing/', '/research/seed-openevo/study/briefing/', 'narrative', '向课题组快速汇报项目从问题定义到当前阻塞的研究进展', '先看到项目已经从“能跑”推进到“可信测量与单变量归因”，以及当前 Q17 仍暂停', '7B 完整结果、OpenEVO vs SEED 尚未完成的边界、Q17 PAUSED 与确定性 gate 必须可见', '按页查看探索路线、硬证据、质量体系和下一步', '.cover-thesis'),
