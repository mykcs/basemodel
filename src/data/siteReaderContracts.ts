...
export const SITE_READER_CONTRACTS = [
  ...
  c('study-briefing', '/research/seed-openevo/study/briefing/', '/research/seed-openevo/study/briefing/', 'narrative', '用固定 16:9 HTML 演讲稿向课题组完成 OpenEVO 暑期考核汇报', '先确认汇报主题、日期和汇报人，再由目录与 TL;DR 给出结果、研究思路和下一步选择', 'SEED 论文值与 OpenEVO 本地 128 题结果不是同协议胜负；DirectApply 尚无最终分数；旧 Q17 twin 已冻结为诊断证据，不能在同一冻结设计里中途改成 DirectApply-only；新的 DirectApply 独立实验从同一冻结起点重新开始，Round0 W2 等价性已通过，probe 并行仍在资格中，尚无 GDR / DirectApply 最终胜负', '按固定页序查看论文风结果表、研究问题、参数机制、GDR / DirectApply 对照、SEED 对照线和最终路线选择', '#briefing-title'),
