...
export const SITE_READER_CONTRACTS = [
  ...
  c('capability-home', '/research/seed-openevo/study/capability-exploration/', '/research/seed-openevo/study/capability-exploration/', 'choice', '理解能力探索最新证据并选择下一条研究路径', '先看到固定同题诊断把大幅 round 回撤缩小为小幅下降和少数任务得失交换', '固定同题诊断不能升级成整体显著遗忘，也不能替代 DirectApply 与 GDR-v1 的最终对照', '进入 R127→R128 固定同题诊断', '[data-research-orientation] [data-reader-purpose]', { maxInteractive: 3, maxHeadings: 1, maxTextChars: 720 }),
  ...
  c('capability-gdr', '/research/seed-openevo/study/capability-exploration/gdr-directapply/', '/research/seed-openevo/study/capability-exploration/gdr-directapply/', 'narrative', '理解 GDR 到 DirectApply 的决策原因以及最新同题诊断补充了什么', '先看到 GDR 实际过滤了什么，再看到同题诊断把大幅 round 回撤缩小很多', 'DirectApply 内部 checkpoint 诊断与 DirectApply-vs-GDR 最终效果证明必须分开', '查看固定同题诊断与仍未解决的问题'),
  c('capability-q17-frontier', '/research/seed-openevo/study/capability-exploration/q17-directapply-frontier/', '/research/seed-openevo/study/capability-exploration/q17-directapply-frontier/', 'focus', '看懂 R127 和 R128 在同样 32 道题上到底差多少', '先看到训练曲线虽然从 76.1 掉到 48.9，但同题重测只有 63.58 → 59.41、完全做对 10 题 → 8 题，因此不能直接说模型整体遗忘', '这里只有 32 道诊断题，最终 128 题没有打开；结果还不足以证明模型整体退步', '等更多模型保存点和 R160 出来，再用同样 32 题复查', '[data-q17-advisor-diagnostics] .lede', { maxInteractive: 4, maxHeadings: 1, maxTextChars: 760 }),
  ...
  c('capability-text-memory', '/research/seed-openevo/study/capability-exploration/text-memory/', '/research/seed-openevo/study/capability-exploration/text-memory/', 'narrative', '理解 Text Memory 怎样整理购物经验、哪里失败以及如何独立验证下一代设计', '先知道短笔记的作用，并区分当前训练的失败记录与下一代待验证方案', 'R104 与 R122 的失败原因形态不同；保留旧笔记不等于更新成功；软件测试不等于模型 shadow 或 WebShop 收益', '比较历史案例，再查看下一代待验证方案和对应证据', '.tm-hero'),
