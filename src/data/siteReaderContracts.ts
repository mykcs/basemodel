...
export const SITE_READER_CONTRACTS = [
  ...
  c('study', '/research/seed-openevo/study/', '/research/seed-openevo/study/', 'choice', '理解实验计划并选择要看的实验阶段', '先知道实验研究回答什么问题以及当前证据到哪里', '实验阶段、历史和当前状态分开', '选择运行、能力探索或结果', '.study-hero', { maxInteractive: 5, maxHeadings: 1, maxTextChars: 760 }),
