...
export const SITE_READER_CONTRACTS = [
  ...
  c('capability-q17-frontier', '/research/seed-openevo/study/capability-exploration/q17-directapply-frontier/', '/research/seed-openevo/study/capability-exploration/q17-directapply-frontier/', 'focus', '理解 Q17 DirectApply 在 R127→R128 固定同题诊断中发生了什么', '先看到同一 32 题只出现小幅下滑和任务能力重排，主要置信区间跨 0，因此尚不能证明整体显著遗忘', '训练 round 波动、固定同题诊断、冻结 final panel 与因果解释必须分开；置信区间边界不能后置', '继续看 entropy 与 update 线索，并在后续 checkpoint / R160 上重复同题诊断', '[data-q17-advisor-diagnostics] .lede', { maxInteractive: 4, maxHeadings: 1, maxTextChars: 760 }),
