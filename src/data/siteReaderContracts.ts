...
export const SITE_READER_CONTRACTS = [
  ...
  c('study-briefing', '/research/seed-openevo/study/briefing/', '/research/seed-openevo/study/briefing/', 'narrative', '向课题组讲清“能力上限 → 参数机制 → 因果控制”的研究思路、最新结果和下一步实验', '先看到 7B / 1.7B 能力上限结果，以及固定 GPU 确定性与干净第 0 轮比较前 10 项科学身份都已通过', '7B 与 1.7B 不是模型大小对比；第 0 轮一致只恢复 Q17 的可归因资格，不是 GDR 效果结果；后续轮次仍受独立继续实验门控制', '按页查看能力上限、参数机制、GDR / DirectApply 单变量对照、Q17 可归因证据与 SEED 对照线', '.cover-thesis'),
