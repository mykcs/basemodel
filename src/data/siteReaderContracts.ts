...
export const SITE_READER_CONTRACTS = [
  ...
  c('capability-q17-directapply-analysis', '/research/seed-openevo/study/capability-exploration/q17-directapply-analysis/', '/research/seed-openevo/study/capability-exploration/q17-directapply-analysis/', 'narrative', '在一页里理解 DirectApply 完整训练、唯一一次冻结终评和 D1 参数方向压缩到底说明什么', '先看到 160 轮 / 20,480 次任务 / 159 次参数更新、Final 60.72 与 50/128，以及“参数几何可压缩但行为不能无损保持”的核心结论', 'R159=72.90 只是训练轮分数；Final=60.72 才是固定 128 题终评；D1 不修改 final state；历史 GDR 37.60 使用不同 final panel，不能直接当方法差', '沿完整轨迹、历史诊断、Final、D1 几何和 32 行行为保持依次核对，再进入具体机制或原始证据', '.q17-analysis__hero', { maxInteractive: 3, maxHeadings: 1, maxTextChars: 1050 }),
