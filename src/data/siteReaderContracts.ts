...
export const SITE_READER_CONTRACTS = [
  ...
  c('study-briefing', '/research/seed-openevo/study/briefing/', '/research/seed-openevo/study/briefing/', 'narrative', '向课题组讲清“能力上限 → 参数机制 → 因果控制”的研究思路、最新结果和下一步实验', '先看到 7B / 1.7B 能力上限结果，以及 Q17 已从干净第 0 轮一致性推进到第 1 轮完成、GDR 第 2 轮在跑', '7B 与 1.7B 不是模型大小对比；第 0 轮一致只恢复 Q17 的可归因资格，第 1 轮完成也不是 GDR 效果结论；几何 successor 始终只做诊断，只有 treatment 后且合同未漂移的差异才允许归因', '按页查看能力上限、参数机制、GDR / DirectApply 单变量对照、Q17 可归因证据与 SEED 对照线', '.cover-thesis'),
