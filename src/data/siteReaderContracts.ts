...
export const SITE_READER_CONTRACTS = [
  ...
  c('study-briefing', '/research/seed-openevo/study/briefing/', '/research/seed-openevo/study/briefing/', 'focus', '快速理解当前 OpenEVO × SEED 研究进展和下一步', '先看到已经知道什么、为什么 Q17 暂停、下一步应优先做什么', '已完成结果、诊断失败、暂停状态和仍未证明的因果主张必须分开', '继续查看阶段汇报中的证据与下一步', '[data-briefing-primary]'),
