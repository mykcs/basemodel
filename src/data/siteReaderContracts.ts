...
export const SITE_READER_CONTRACTS = [
  ...
  c('capability-q17-frontier', '/research/seed-openevo/study/capability-exploration/q17-directapply-frontier/', '/research/seed-openevo/study/capability-exploration/q17-directapply-frontier/', 'narrative', '理解 Q17 DirectApply 为什么从平台期问题转向 frontier 诊断与 successor 计划', '先看到模型没有简单卡死，而是经历回撤后恢复；接着看到哪些指标和实验仍待填空', '计划、诊断、未完成 successor 和冻结 final panel 边界必须分开', '先补完 selected-vs-success task identity 核对，再决定是否启动 Frontier Curriculum pilot', '[data-reader-frontier] .lede', { maxInteractive: 4, maxHeadings: 1, maxTextChars: 720 }),
