...
export const SITE_READER_CONTRACTS = [
  ...
  c('capability-bounded-effective-state-gdr', '/research/seed-openevo/study/capability-exploration/bounded-effective-state-gdr/', '/research/seed-openevo/study/capability-exploration/bounded-effective-state-gdr/', 'narrative', '理解为什么 Bounded 解决状态大小以后，还要把 GDR 的控制对象改成 effective state / effective write，以及新的正式配对实验比较什么', '先看到 rank128 bounded state、OFF/ON 正式设计、正式实验已启动但因 Carrier Health 诊断暂停，以及“正式结果仍未产生”', 'first-generation Gated-Delta D1、Bounded recurrence 和 Effective-State successor 是三个不同科学对象；诊断暂停状态、运行中 round、partial W&B、单 checkpoint 和 qualification-only 数字都不能升级成 formal efficacy', '沿 1.052 factor boundary、657.836 controller boundary、Effective-State sequential write 和 160-round matched design 阅读，再等待 sealed formal result', '.esg__lede', { maxInteractive: 2, maxHeadings: 1, maxTextChars: 900 }),
