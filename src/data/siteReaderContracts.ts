...
export const SITE_READER_CONTRACTS = [
  ...
  c('study', '/research/seed-openevo/study/', '/research/seed-openevo/study/', 'choice', '先选择自己要看的那一次 OpenEVO × WebShop 实验，再沿它的结果和分析继续阅读', '先看到“按五次主要实验组织”的入口，不再要求读者先理解 Results / Capability / Stage 等内部分类', '历史 1.7B GDR-v1 同时属于 3B + 1.7B 后继实验；DirectApply 是后续 No-GDR 对照；跨实验页面保留但不再抢主导航', '选择一次实验，再进入它的结果或由它引出的分析', '.study-hero__lede', { maxInteractive: 5, maxHeadings: 1, maxTextChars: 620 }),
