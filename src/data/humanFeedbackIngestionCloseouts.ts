...
export const OPEN_EVO_BRIEFING_POST_HPL_APPLICATION_INGESTION_20260909: HumanFeedbackIngestionCloseoutRecord = {
  id: 'INGESTION-20260909-OPENEVO-BRIEFING-POST-HPL-APPLICATION',
  schema: 'human-feedback-ingestion-closeout.v2',
  task: 'OpenEVO briefing after applying current HPL rules: binary-contrast recurrence, whole-deck recheck, and PR #605 concrete acceptance',
  sourceWindow: {
    start: '2026-09-09 · after PR #607 merged the prior briefing-storyline HPL closeout, owner asks to apply those learned rules back to PR #605',
    end: '2026-09-09 · PR #605 exact head 56b5120b is owner-approved, Vercel-gated, and merged as main@edad8507',
    route: '/research/seed-openevo/study/briefing/',
    pullRequest: 605,
    finalOwnerVisibleHead: '56b5120b22b6c709aaf485e3b1fdea348fb3041b',
    mainAtCloseout: 'edad8507de74fe3ead01512954c7355456e182de',
    mergedMainCommit: 'edad8507de74fe3ead01512954c7355456e182de',
    finalVerdict: 'accepted',
  },
  ...
  ledger: [
    {
      id: 'FB-S5-01-APPLY-LEARNED-RULES',
      date: '2026-09-09',
      ownerSignal: '按照这些规则 再修改我的 slides',
      disposition: 'merge-duplicate',
      rationale: '强化 CASE-083：HPL 的价值必须体现在下一版生成和验收，而不是停在 closeout 文档；这条是执行/学习闭环要求，不新建视觉规则。',
      caseIds: ['CASE-083'],
      preferenceIds: ['PREF-FEEDBACK-LEARNING-LOOP'],
      pairIds: ['PAIR-083-LEARNING-LOOP'],
    },
    {
      id: 'FB-S5-02-BINARY-CONTRAST-REPEAT',
      date: '2026-09-09',
      ownerSignal: 'Slide 的第3页还是犯了“不是……而是……”这样的错误。再照着这个标准看一看，然后改。',
      disposition: 'ingest',
      rationale: '这是显式“还是犯了”的重复纠正。复用 CASE-081 的防御式否定机制，不创建“禁止不是/而是”的近义黑名单；新增 repeat event + concrete Gold Pair，使 defensive-negation-opening / anticipatory-rebuttal 升为 hard。',
      eventIds: ['EVENT-20260909-BRIEFING-BINARY-CONTRAST-REPEAT'],
      caseIds: ['CASE-081', 'CASE-090'],
      preferenceIds: ['PREF-DIRECT-FACTS', 'PREF-EVENT-FIRST-RESEARCH-HEADINGS'],
      pairIds: ['PAIR-081-BINARY-CONTRAST-SUMMARY'],
      visualReferenceIds: ['VISUAL-BRIEFING-BINARY-CONTRAST-REJECTED', 'VISUAL-BRIEFING-605-ACCEPTED-SILVER'],
      excludedSubsignals: ['“不是 / 而是”不是禁词；科学排除、责任边界和贴近 claim 的否定句仍可正常使用'],
    },
    {
      id: 'FB-S5-03-APPLY-LEARNED-RULES-AGAIN',
      date: '2026-09-09',
      ownerSignal: '按照这些规则 再修改我的 slides',
      disposition: 'merge-duplicate',
      rationale: '第二次要求把既有规则应用到整套 slides，强化 CASE-083 的 pre-write + cold-read 目标；不把“每次都必须重写所有页面”泛化成全站规则。',
      caseIds: ['CASE-083'],
      preferenceIds: ['PREF-FEEDBACK-LEARNING-LOOP'],
      pairIds: ['PAIR-083-LEARNING-LOOP'],
    },
    {
      id: 'FB-S5-04-PR605-CONCRETE-ACCEPTANCE',
      date: '2026-09-09',
      ownerSignal: '合并进 main',
      disposition: 'ingest',
      rationale: '明确接受 exact head 56b5120b 这个 concrete result。记录 accepted event + Silver visual，并显式保持“accepted ≠ canonical / Golden”。',
      eventIds: ['EVENT-20260909-BRIEFING-605-ACCEPTED'],
      caseIds: ['CASE-081', 'CASE-082', 'CASE-084', 'CASE-089', 'CASE-090'],
      visualReferenceIds: ['VISUAL-BRIEFING-605-ACCEPTED-SILVER'],
    },
    {
      id: 'FB-S5-05-VERCEL-DEV-STATUS',
      date: '2026-09-09',
      ownerSignal: 'vercel dev 呢',
      disposition: 'task-fact-not-preference',
      rationale: '这是对合并后部署状态的操作核查，不是 rendered briefing 的长期文案、视觉或交互偏好。',
      scopes: ['workflow'],
    },
    {
      id: 'FB-S5-06-LINK-NOT-VISIBLE',
      date: '2026-09-09',
      ownerSignal: '没看见 link',
      disposition: 'out-of-scope',
      rationale: '这是当前 ChatGPT 回复没有把可点击 Vercel URL 显式贴出的交付问题；不能偷换成网站页面必须新增某种 link component 的视觉规则。',
      scopes: ['chat-response'],
    },
    {
      id: 'FB-S5-07-HPL-SUCCESS-CRITERION-REPEAT',
      date: '2026-09-09',
      ownerSignal: '未来完全不同的 Agent 在没有读过本对话的情况下，只依赖 current main，也应该能在第一次生成时明显更接近我的要求，并减少我重复纠正同一类问题的次数。',
      disposition: 'merge-duplicate',
      rationale: '再次强化 CASE-083 / PREF-FEEDBACK-LEARNING-LOOP；成功指标仍是 first-draft improvement + fewer repeated corrections，不创建新的 workflow synonym。',
      caseIds: ['CASE-083'],
      preferenceIds: ['PREF-FEEDBACK-LEARNING-LOOP'],
      pairIds: ['PAIR-083-LEARNING-LOOP'],
    },
  ],
  futureTaskQuery: '准备下一次科研组会：有一页要概览做过的实验，另有两阶段训练背景、低分诊断、参数 gate 和最终结果。听众懂机器学习但不了解项目内部上下文。请在第一稿前检查标题是否先制造作者预设的二元反驳或压缩标签，安排最小方法背景和诊断因果顺序，并说明哪些历史视觉可以参考、哪些只代表具体版本被接受。',
  expectedRetrievedSignals: [
  ...
  evaluationProof: {
    hardFamily: 'defensive-negation-opening',
    mechanism: 'candidate receipt verifier must reject a future briefing candidate when the newly repeated defensive-negation family is omitted from hardFamiliesChecked, then pass after restoring the check; this tests the mechanism, not a word blacklist',
  },
  automationGap: 'Conversation-to-ledger extraction remains manually interpreted because the repository has no direct ChatGPT turn-export API. The repository can validate the structured source window, exact-head acceptance, visual supersession, retrieval, severity, and evaluation recurrence; it cannot infer the owner turns automatically.',
};
