...
export const HUMAN_FEEDBACK_EVENTS: HumanFeedbackEvent[] = [
  ...
  {
    id: 'EVENT-20260909-BRIEFING-ORPHAN-CONTEXT',
    date: '2026-09-09',
    caseIds: ['CASE-082'],
    scopes: ['briefing', 'research-copy'],
    artifact: 'OpenEVO summer review',
    variantId: 'briefing-orphan-experiment-context',
    comparedToVariantId: 'briefing-chronology-responsive-refinement',
    verdict: 'rejected',
    ownerSignal: '整体已经明显更好，但几乎每一页仍缺少足够的前因：观众不知道 OpenEVO / WebShop / SEED 的关系，也不知道为什么会从 15 试到 30、为什么 2048 会变成 4096。',
    reasons: ['科研转折需要让零上下文听众知道上一个观察是什么以及为什么这个假设值得测', '具体参数必须说明它来自哪里和它在当时实验里承担什么角色'],
    failureMechanisms: ['missing-local-causal-context', 'orphan-parameter-transition', 'author-context-required', 'missing-first-use-research-frame'],
    repeatSignal: 'explicit',
  },
  {
