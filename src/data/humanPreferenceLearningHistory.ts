...
export const HUMAN_FEEDBACK_EVENTS: HumanFeedbackEvent[] = [
  ...
  },
  {
    ...
    failureMechanisms: ['defensive-negation-opening', 'anticipatory-rebuttal'],
    repeatSignal: 'explicit',
    requestedSuccessorVariantId: 'briefing-hpl-applied-final-56b5120b',
  ...
  {
    id: 'EVENT-20260909-BRIEFING-605-ACCEPTED',
    date: '2026-09-09',
    caseIds: ['CASE-081', 'CASE-082', 'CASE-084', 'CASE-089', 'CASE-090'],
    scopes: ['briefing', 'research-copy', 'research-ui', 'visual', 'briefing-mobile', 'briefing-desktop'],
    artifact: 'OpenEVO summer review · HPL-applied final successor accepted into main',
    variantId: 'briefing-hpl-applied-final-56b5120b',
    comparedToVariantId: 'briefing-binary-contrast-recurrence-e9b767d4',
    verdict: 'accepted',
    ownerSignal: '合并进 main',
    reasons: ['owner 在看过 56b5120b 对应 Preview 后明确授权把该具体版本合入 main', '这是具体结果接受；没有“以后都照这套视觉模板”的 future-reference 语言，因此不升级 canonical / Golden'],
    failureMechanisms: [],
    evidence: { route: '/research/seed-openevo/study/briefing/', pullRequest: 605, gitSha: '56b5120b22b6c709aaf485e3b1fdea348fb3041b', ledgerId: 'FB-S5-04-PR605-CONCRETE-ACCEPTANCE' },
  },
...
export const HUMAN_PREFERENCE_TRAJECTORIES: PreferenceTrajectory[] = [
  ...
  },
  {
    ...
    scopes: ['briefing', 'research-copy', 'visual'],
    variantIds: ['briefing-diagnostic-intervention-first-0aa9693c', 'briefing-log-first-a83eb0da', 'briefing-storyline-human-causal-670ab9b4', 'briefing-binary-contrast-recurrence-e9b767d4', 'briefing-hpl-applied-final-56b5120b'],
    comparisons: [
      {
      ...
      {
        betterVariantId: 'briefing-hpl-applied-final-56b5120b',
        worseVariantId: 'briefing-binary-contrast-recurrence-e9b767d4',
        reason: 'owner 明确指出 e9b767d4 的 Slide 3 又回到“我们不是只跑一次实验，而是……”的模板化二元对抗标题；最终 56b5120b 改成直接主题“我们做过哪些尝试”，并在整套 slides 冷读后获得合并授权。',
        failureMechanisms: ['defensive-negation-opening', 'anticipatory-rebuttal'],
      },
    ],
    note: '670ab9b4 是上一轮 closeout 当时的 current-candidate；之后 e9b767d4 仍复发防御式二元标题并被 owner 拒绝。最终 56b5120b 经过整套 HPL 冷读式修正后被 owner 明确要求合并，因此 concrete accepted；但 owner 从未授权未来视觉模板，所以 trajectory 仍没有 canonicalVariantId / Golden。',
  },
  {
    id: 'TRAJECTORY-BRIEFING-EXPERIMENT-CHART-GRAMMAR-20260909',
    scopes: ['briefing', 'research-ui', 'visual'],
    variantIds: ['briefing-mixed-experiment-charts', 'briefing-unified-experiment-charts-59f46044'],
    comparisons: [
      {
    ...
    note: 'PR #604 的具体统一图表实现被接受；这条 trajectory 学的是同类证据的视觉语法一致性，不是固定数值轴、固定颜色模板或所有研究图都必须长这样。',
  },
  {
...
export const HUMAN_VISUAL_REFERENCE_SET: HumanVisualReference[] = [
  ...
  },
  {
    ...
    note: '这是上一轮 source window 的历史 CURRENT-CANDIDATE；后续已被 PR #605 final accepted successor 覆盖。浅红问题框、SEED 灰色 pill 等具体样式仍只绑定本 briefing，不升级成全站模板。',
    supersededByReferenceId: 'VISUAL-BRIEFING-605-ACCEPTED-SILVER',
  },
  {
  ...
  {
    id: 'VISUAL-BRIEFING-605-ACCEPTED-SILVER',
    tier: 'silver',
    scopes: ['briefing', 'visual', 'briefing-mobile', 'briefing-desktop'],
    artifact: 'OpenEVO briefing · HPL-applied final accepted successor',
    repository: 'mykcs/basemodel',
    gitSha: '56b5120b22b6c709aaf485e3b1fdea348fb3041b',
    pullRequest: 605,
    route: '/research/seed-openevo/study/briefing/',
    ownerEvidence: 'owner 看过该 final Preview 后明确说“合并进 main”；PR #605 exact head 56b5120b 随后通过 exact-head Vercel gate 并合入 main。',
    note: 'Concrete accepted result → Silver。没有“以后按这版 / 作为模板”的视觉授权，因此仍不是 Golden；可用 repo + exact SHA + route + 390/1280 viewport 重建。',
  },
  {
