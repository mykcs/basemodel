...
export const HUMAN_FEEDBACK_PRECEDENTS: HumanFeedbackPrecedent[] = [
...

  {
    ...
    tags: ['科研网页', '消融实验', '论文结构', 'ICLR', '命名一致', 'Bounded State', 'GDR', '公式', 'Task Vector', 'entropy'],
    ...
    positiveSignals: ['三行消融表：普通 OpenEVO / + Bounded State / + GDR，并用对勾显示机制', '一个实验在标题、表格、图例和正文使用同一公共名称', '真实 SD-LoRA 扩展性问题先产生 Bounded 方法，再给公式和实验', 'Task Vector / norm / 步数 / entropy 集中放在 Analysis / Discussion'],
  },
];
