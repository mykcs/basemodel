...
describe('SEED × OpenEVO summer review HTML deck', () => {
  ...
  it('adds a Q17 frontier roadmap slide with blanks for unmeasured successor results', () => {
    ...
    expect(directApplyFrontierPlan.source_plan.exact_head_sha).toBe('369053c94c1fd9b4484cb38c9c244dc97e78521a');
  ...
  it('keeps the scientific story in the requested causal order', () => {
    const ids = ['results','openevo-method','stage2-gate','component-cap','seven-b','diagnostic-entry','horizon-diagnostic','capacity-diagnostic','training-dynamics','mechanism','taskvector-behavior','gdr','one-seven-b','directapply','directapply-progress','directapply-plateau','frontier-roadmap','technical-work-summary','next'];
