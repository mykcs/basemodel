...
const enPage = read('../../docs/archive/site-en/src/pages/en/research/seed-openevo/study/briefing/index.astro.archive');
const zhTechnical = read('../pages/research/seed-openevo/study/briefing/technical-notes/index.astro');
const enTechnical = read('../../docs/archive/site-en/src/pages/en/research/seed-openevo/study/briefing/technical-notes/index.astro.archive');
const zhFrontierPage = read('../pages/research/seed-openevo/study/capability-exploration/q17-directapply-frontier/index.astro');
const enFrontierPage = read('../../docs/archive/site-en/src/pages/en/research/seed-openevo/study/capability-exploration/q17-directapply-frontier/index.astro.archive');
