...
const benchmarkEn = read('docs/archive/site-en/src/pages/en/research/seed-openevo/flow/benchmarks.astro.archive');
...
const openevoEn = read('docs/archive/site-en/src/pages/en/research/seed-openevo/flow/openevo.astro.archive');
