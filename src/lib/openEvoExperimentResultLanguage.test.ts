...
describe('OpenEvo capability-exploration result language', () => {
  it('projects current 202609030400 authority without turning the website into a live database', () => {
    ...
    expect(currentAuthorityProjection).toContain('4915dbdd75678da9a5752f991e70685c67dd497b');
    expect(currentAuthorityProjection).toContain('ac130148ee08b6462d9728e482a858fe5f514047');
    ...
    expect(currentAuthorityProjection).toContain('formalRolloutReplay: 0');
    expect(currentAuthorityProjection).toContain('scientificSemanticsChanged: false');
    expect(currentAuthorityProjection).not.toContain('RUNNING_EXTERNAL_EXECUTOR_ADOPTED');
