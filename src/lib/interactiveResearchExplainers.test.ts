...
const evoZh = read('src/pages/research/seed-openevo/flow/openevo.astro');
const evoEn = read('docs/archive/site-en/src/pages/en/research/seed-openevo/flow/openevo.astro.archive');
