...
export function ServerExplainer({ locale, step, onStep }: { locale: Locale; step: number; onStep: (step: number) => void }) {
  ...
  const edges: EdgeSpec[] = [
    ...
    { id: 'socket-daemon', from: 'srv-socket', to: 'srv-daemon', tone: 'state', fromAnchor: 'top', toAnchor: 'bottom', dashed: true, shape: 'smooth', active: step >= 2 },
    ...
    { id: 'dev-workspace', from: 'srv-dev', to: 'srv-workspace', tone: 'persist', fromAnchor: 'bottom', toAnchor: 'left', active: step >= 4 },
