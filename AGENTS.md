...
8. [`docs/agents/current/website-design-spec.md`](docs/agents/current/website-design-spec.md) — **canonical for every user-facing copy task**: defines “说人话 / 去 AI 味”, subject-first headings, natural technical language, evidence layering, and current preference precedence. **Also read [`docs/agents/current/website-copy-cases.md`](docs/agents/current/website-copy-cases.md) for every user-facing copy/design task**; live human-feedback cases are executable precedent, not an optional tone appendix.
